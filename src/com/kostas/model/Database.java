...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_ALTER_RUNNING_2 = "ALTER TABLE running ADD COLUMN IS_SHARED INTEGER default 0;";
    private static final String DATABASE_ALTER_RUNNING_3 = "ALTER TABLE running ADD COLUMN username TEXT;";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 3) {
            ...
            db.execSQL(DATABASE_ALTER_RUNNING_3);
            db.execSQL(ContentDescriptor.User.createTable());
            db.execSQL(ContentDescriptor.RunningFriend.createTable());
            db.execSQL(ContentDescriptor.IntervalFriend.createTable());
        }
